    ...
    new Ext.grid.EditorGridPanel({
     ...
     items: [
        ...
        columns: [
            ...
            {header: '商品规格', dataIndex: 'size', width:100,align:'center'},
        ...
        columns: [
          ...
          window.deleteRecord = function(id) {
            ...
            var pSize = record.data.size;
                  Ext.Msg.confirm('提示', '确定要删除 “' + pName + ' (' + pSize + ')” 吗？', function (button) {
                if (button == 'yes') {
                        store.remove(record);
                      }
                    });
